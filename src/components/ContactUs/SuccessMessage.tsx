  ...
  return (
    <ModalOverlay>
      <ModalContent>
          ...
          <svg width="185" height="185" viewBox="0 0 185 185" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              ...
              <clipPath id="clip0_100_22169">
                <rect width="177" height="177" fill="white" transform="translate(4 4)" />
              </clipPath>
            </defs>
          </svg>
        </IconContainer>
        ...
        <Message>We've received your message and will get back to you shortly.</Message>
        
        <ButtonWrapper>
          <MagicButton onClick={onClose} type="button">
           <IconsStars src={IconStars} alt="Stars" />  Back to Home 
          </MagicButton>
        </ButtonWrapper>
      </ModalContent>
    </ModalOverlay>
